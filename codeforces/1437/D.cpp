...
int main()
{
    ...
    for(int t = 1;t<=T;t++)
    {
        ...
        for(int i=1;i<n;i++)
        {
        	...
        	{
        		vertex[curr].first.second++;
        		vertex.push_back({{order[i],0},vertex[curr].second + 1});
        	}
        	else
        	{
        		curr++;
        ...
        // {
        	// // cout<<vertex[i].first.first<<" "<<vertex[i].first.second<<" "<<vertex[i].second<<endl;
        // }
        cout<<vertex.back().second<<endl;
    }
